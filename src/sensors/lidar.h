...
struct Lidar
{
	...
	{
		// TODO:: set minDistance to 5 instead of 0 to remove points from roof of ego car
		minDistance = 5;
		maxDistance = 50;
		resoultion = 0.2;
		// TODO:: set sderr to 0.2 instead of 0.0 to get more interesting pcd files
		sderr = 0.2;
		cars = setCars;
		...
		// TODO:: set to pi/64 instead of pi/6 to get higher resoultion pcd
